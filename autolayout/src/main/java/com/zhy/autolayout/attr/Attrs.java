...
public interface Attrs {
    ...
    int MARGIN_START = MARGIN_BOTTOM << 1;//margin_start
    int MARGIN_END = MARGIN_START << 1;//margin_end
    int PADDING_LEFT = MARGIN_END << 1;
    int PADDING_TOP = PADDING_LEFT << 1;
    int PADDING_RIGHT = PADDING_TOP << 1;
    int PADDING_BOTTOM = PADDING_RIGHT << 1;
    int PADDING_START = PADDING_BOTTOM << 1;//paddingStart
    int PADDING_END = PADDING_START << 1;   //paddingEnd
    int MIN_WIDTH = PADDING_END << 1;
